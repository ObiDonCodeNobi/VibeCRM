...
{
    /// <summary>
    /// Represents a many-to-many relationship between teams and users
    /// </summary>
    public class Team_User : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { TeamId, UserId };
