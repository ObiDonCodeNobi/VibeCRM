...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and sales orders
    /// </summary>
    public class Company_SalesOrder : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, SalesOrderId };
