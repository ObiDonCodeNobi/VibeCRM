...
{
    /// <summary>
    /// Represents a many-to-many relationship between activities and notes
    /// </summary>
    public class Activity_Note : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { ActivityId, NoteId };
