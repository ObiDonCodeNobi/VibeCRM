...
{
    /// <summary>
    /// Represents a many-to-many relationship between payments and notes
    /// </summary>
    public class Payment_Note : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PaymentId, NoteId };
