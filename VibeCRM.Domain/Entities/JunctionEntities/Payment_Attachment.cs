...
{
    /// <summary>
    /// Represents a many-to-many relationship between payments and attachments
    /// </summary>
    public class Payment_Attachment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PaymentId, AttachmentId };
