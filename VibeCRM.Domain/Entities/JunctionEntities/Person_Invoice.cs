...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and invoices
    /// </summary>
    public class Person_Invoice : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, InvoiceId };
