...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and notes
    /// </summary>
    public class Person_Note : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, NoteId };
