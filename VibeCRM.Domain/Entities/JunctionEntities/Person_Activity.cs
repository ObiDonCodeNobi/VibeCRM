...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and activities
    /// </summary>
    public class Person_Activity : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, ActivityId };
