...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and addresses
    /// </summary>
    public class Company_Address : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, AddressId };
