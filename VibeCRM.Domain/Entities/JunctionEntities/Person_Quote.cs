...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and quotes
    /// </summary>
    public class Person_Quote : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, QuoteId };
