...
{
    /// <summary>
    /// Represents a many-to-many relationship between invoices and attachments
    /// </summary>
    public class Invoice_Attachment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { InvoiceId, AttachmentId };
