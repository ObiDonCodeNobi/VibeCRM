...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and activities
    /// </summary>
    public class Company_Activity : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, ActivityId };
