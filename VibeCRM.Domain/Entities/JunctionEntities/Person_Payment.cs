...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and payments
    /// </summary>
    public class Person_Payment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, PaymentId };
