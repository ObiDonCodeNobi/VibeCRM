...
{
    /// <summary>
    /// Represents a many-to-many relationship between sales orders and attachments
    /// </summary>
    public class SalesOrder_Attachment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { SalesOrderId, AttachmentId };
