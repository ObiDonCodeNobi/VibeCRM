...
{
    /// <summary>
    /// Represents a many-to-many relationship between payments and payment line items
    /// </summary>
    public class Payment_PaymentLineItem : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        /// <summary>
        /// Gets or sets the payment line item identifier
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the payment line item
        /// </summary>
        public PaymentLineItem? PaymentLineItem { get; set; }
        ...
        public object GetId() => new { PaymentId, PaymentLineItemId };
