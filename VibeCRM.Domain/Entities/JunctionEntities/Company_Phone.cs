...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and phone numbers
    /// </summary>
    public class Company_Phone : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, PhoneId };
