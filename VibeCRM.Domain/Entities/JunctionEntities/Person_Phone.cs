...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and phones
    /// </summary>
    public class Person_Phone : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, PhoneId };
