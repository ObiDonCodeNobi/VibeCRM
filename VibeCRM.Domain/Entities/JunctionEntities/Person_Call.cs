...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and calls
    /// </summary>
    public class Person_Call : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, CallId };
