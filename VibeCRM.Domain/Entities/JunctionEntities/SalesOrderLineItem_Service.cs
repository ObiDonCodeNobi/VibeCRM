...
{
    /// <summary>
    /// Represents a many-to-many relationship between sales order line items and services
    /// </summary>
    public class SalesOrderLineItem_Service : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { SalesOrderLineItemId, ServiceId };
