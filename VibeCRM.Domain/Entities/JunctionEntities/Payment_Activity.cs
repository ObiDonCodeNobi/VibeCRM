...
{
    /// <summary>
    /// Represents a many-to-many relationship between payments and activities
    /// </summary>
    public class Payment_Activity : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PaymentId, ActivityId };
