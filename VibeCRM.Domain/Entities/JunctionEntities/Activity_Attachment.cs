...
{
    /// <summary>
    /// Represents a many-to-many relationship between activities and attachments
    /// </summary>
    public class Activity_Attachment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { ActivityId, AttachmentId };
