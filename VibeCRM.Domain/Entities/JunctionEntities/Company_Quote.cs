...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and quotes
    /// </summary>
    public class Company_Quote : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        /// <summary>
        /// Gets or sets the quote. May be null if the relationship is being loaded lazily.
        /// </summary>
