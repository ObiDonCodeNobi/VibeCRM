...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and attachments
    /// </summary>
    public class Person_Attachment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, AttachmentId };
