...
{
    /// <summary>
    /// Represents a many-to-many relationship between invoices and invoice line items
    /// </summary>
    public class Invoice_InvoiceLineItem : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        /// <summary>
        /// Gets or sets the invoice line item
        /// </summary>
        ...
        public object GetId() => new { InvoiceId, InvoiceLineItemId };
