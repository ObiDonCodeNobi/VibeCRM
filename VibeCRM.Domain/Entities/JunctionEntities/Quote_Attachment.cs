...
{
    /// <summary>
    /// Represents a many-to-many relationship between quotes and attachments
    /// </summary>
    public class Quote_Attachment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { QuoteId, AttachmentId };
