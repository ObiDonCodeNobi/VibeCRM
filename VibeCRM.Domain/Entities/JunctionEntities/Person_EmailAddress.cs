...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and email addresses
    /// </summary>
    public class Person_EmailAddress : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, EmailAddressId };
