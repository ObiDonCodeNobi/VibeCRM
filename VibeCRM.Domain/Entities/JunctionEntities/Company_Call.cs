...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and calls
    /// </summary>
    public class Company_Call : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, CallId };
