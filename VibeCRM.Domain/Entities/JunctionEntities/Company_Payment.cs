...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and payments
    /// </summary>
    public class Company_Payment : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, PaymentId };
