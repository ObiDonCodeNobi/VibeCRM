...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and email addresses
    /// </summary>
    public class Company_EmailAddress : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, EmailAddressId };
