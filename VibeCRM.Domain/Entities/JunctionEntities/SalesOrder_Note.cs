...
{
    /// <summary>
    /// Represents a many-to-many relationship between sales orders and notes
    /// </summary>
    public class SalesOrder_Note : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { SalesOrderId, NoteId };
