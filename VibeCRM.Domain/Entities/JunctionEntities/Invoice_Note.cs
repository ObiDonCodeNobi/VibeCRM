...
{
    /// <summary>
    /// Represents a many-to-many relationship between invoices and notes
    /// </summary>
    public class Invoice_Note : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { InvoiceId, NoteId };
