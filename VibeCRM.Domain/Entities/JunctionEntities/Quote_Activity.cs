...
{
    /// <summary>
    /// Represents a junction entity that maps the many-to-many relationship between quotes and activities
    /// </summary>
    public class Quote_Activity : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { QuoteId, ActivityId };
