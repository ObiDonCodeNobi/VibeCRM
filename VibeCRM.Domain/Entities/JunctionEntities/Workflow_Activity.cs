...
{
    /// <summary>
    /// Represents a many-to-many relationship between workflows and activities
    /// </summary>
    public class Workflow_Activity : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { WorkflowId, ActivityId };
