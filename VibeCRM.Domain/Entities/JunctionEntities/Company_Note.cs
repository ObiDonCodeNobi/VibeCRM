...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and notes
    /// </summary>
    public class Company_Note : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, NoteId };
