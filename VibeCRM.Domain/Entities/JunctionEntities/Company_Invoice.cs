...
{
    /// <summary>
    /// Represents a many-to-many relationship between companies and invoices
    /// </summary>
    public class Company_Invoice : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { CompanyId, InvoiceId };
