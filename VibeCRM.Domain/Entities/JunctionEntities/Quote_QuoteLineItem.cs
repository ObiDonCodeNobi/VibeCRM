...
{
    /// <summary>
    /// Represents a many-to-many relationship between quotes and quote line items
    /// </summary>
    public class Quote_QuoteLineItem : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        /// <summary>
        /// Gets or sets the quote line item identifier
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the quote line item
        /// </summary>
        ...
        public object GetId() => new { QuoteId, QuoteLineItemId };
