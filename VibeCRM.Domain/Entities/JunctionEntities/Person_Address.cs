...
{
    /// <summary>
    /// Represents a many-to-many relationship between persons and addresses
    /// </summary>
    public class Person_Address : IEntity, IHasDomainEvents, ISoftDelete
    {
        ...
        public object GetId() => new { PersonId, AddressId };
