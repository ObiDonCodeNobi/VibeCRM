...
{
    /// <summary>
    /// Validator for the CreateQuoteLineItemCommand
    /// </summary>
    public class CreateQuoteLineItemCommandValidator : AbstractValidator<CreateQuoteLineItemCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateQuoteLineItemCommandValidator"/> class
        /// </summary>
        public CreateQuoteLineItemCommandValidator()
        {
            RuleFor(x => x.QuoteId)
