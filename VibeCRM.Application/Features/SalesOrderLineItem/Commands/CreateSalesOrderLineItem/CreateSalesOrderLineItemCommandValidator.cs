...
{
    /// <summary>
    /// Validator for the CreateSalesOrderLineItemCommand
    /// </summary>
    public class CreateSalesOrderLineItemCommandValidator : AbstractValidator<CreateSalesOrderLineItemCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSalesOrderLineItemCommandValidator"/> class
        /// </summary>
        public CreateSalesOrderLineItemCommandValidator()
        {
